...
このディレクトリには、**Promps** の技術ドキュメントが含まれています。全フェーズ（Phase 0-6）が完了しており、DSL パーシング、Blockly.js ビジュアルエディタ、プロジェクト永続化、文法検証、パターンテンプレート、i18n（日英）対応を含む機能を備えています。
...
- **[ユーザーガイド（日本語）](./user/ja/USER_GUIDE.md)** - Promps の使い方
  - ブロックの基本操作
  - 文法検証と自動修正
  - パターンテンプレート
  - プロジェクトの保存/読込
  - キーボードショートカット
- **[User Guide (English)](./user/en/USER_GUIDE.md)** - 英語版ユーザーガイド
...
**テスト**:
- **[テスト概要（日本語）](./testing/ja/TEST_OVERVIEW.md)** - テスト戦略と実行方法
- **[Test Overview (English)](./testing/en/TEST_OVERVIEW.md)** - テスト戦略（英語版、282テスト）
- **[Frontend Test Index (English)](./testing/en/FRONTEND_TEST_INDEX.md)** - フロントエンドテスト詳細（190テスト）
...
| フェーズ | 機能 | 状態 |
|----------|------|------|
| Phase 0 | コア DSL パーシング | 完了 |
| Phase 1 | Tauri + Blockly.js GUI | 完了 |
| Phase 2 | 助詞ブロック | 完了 |
| Phase 3 | 動詞ブロック | 完了 |
| Phase 4 | プロジェクト永続化 | 完了 |
| Phase 5 | 文法検証 | 完了 |
| Phase 6 | パターンテンプレート・句読点 | 完了 |
| v1.0.0 | 安定版リリース | リリース済 |
| v1.1.0 | 英語文法エンジン・i18n | リリース済 |
| v1.3.3 | CSS変数移行・セキュリティ | リリース済 |
