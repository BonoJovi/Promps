...
| PromptPart | コアデータ構造（文 + 型） | CORE_FEATURES.md、API_REFERENCE.md |
| 文レベル粒度 | なぜトークンではなく文か | CORE_FEATURES.md、ARCHITECTURE.md |
...
### なぜトークンレベルではなく文レベルの `is_noun` なのか？

**簡潔な回答**: 意味的単位を保持するため。

**詳細な回答**: ARCHITECTURE.md「決定 2: 文レベル is_noun」を参照
